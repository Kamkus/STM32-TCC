...
# button.pack()
screen.createInputBox("yREF[degC]", screen.yRef, 20, 100-70, "normal")
...
screen.createButton("Wyczyść Dane", 'CLEAR_DATA','ALL', 20, 190-70)
screen.createButton("Wykres [Temp]", 'SHOW_PLOT','TEMP', 110, 190-70)
screen.createButton("Wykres [Uchyb]", 'SHOW_PLOT','UCHYB', 205, 190-70)
screen.createButton("Wykres [PWM]", 'SHOW_PLOT','PWM', 305, 190-70)
